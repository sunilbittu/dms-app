    ...
    return (
        ...
        >
            ...
            <div className="w-full max-w-md relative z-10 mr-16">
                ...
                {/* Heading */}
                <h1 className="text-3xl font-medium text-center mb-6">DMS - Forgot Password</h1>
...
export default function ForgotPassword() {
    ...
    return (
        ...
        >
            {/* Semi-transparent overlay */}
            <div className="absolute inset-0 bg-black/60" data-oid="w4c8vp6"></div>

            <div className="w-full max-w-md relative z-10 mr-16" data-oid="4hhh9hr">
                {/* Logo */}
                <div className="flex flex-col items-center mb-12" data-oid="cdmpb--">
                    <img
                        src="/images/datadot-logo.png"
                        alt="Datadot Logo"
                        className="h-16 w-auto mb-2"
                    ...
                    <div className="text-sm text-orange-500 font-medium" data-oid="skfd675">
                        Business Re-engineering
                    </div>
                </div>

                {/* Heading */}
                <h1 className="text-3xl font-medium text-center mb-6" data-oid="6mihkmy">
                    Forgot Password
                </h1>

                {/* Form */}
                <form onSubmit={handleSubmit} className="space-y-6" data-oid="fbjf5bp">
                    {message && (
                        <div
                            className="bg-blue-900/50 text-blue-200 p-3 rounded-md text-sm"
                            data-oid="f.bf9n-"
                        >
                            {message}
                        </div>
                    ...
                    <div className="space-y-2" data-oid="gsugekx">
                        <label
                            htmlFor="username"
                            className="block text-sm font-medium text-gray-300"
                            data-oid="-7hh7up"
                        ...
                        <p className="text-sm text-gray-400 mt-1" data-oid="m1oddwo">
                            Enter your username and we'll send you instructions to reset your
                            password.
                        </p>
                    </div>
                    ...
                    <div
                        className="flex items-center justify-between space-x-4 pt-2"
                        data-oid="qabv-sd"
                    >
                        <Link
                            href="/"
                            className="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                            data-oid="u2dgx2."
                        >
                            Cancel
                        </Link>
                ...
                <div className="mt-6 text-center" data-oid="lknqzce">
                    <Link
                        href="/"
                        className="text-sm text-blue-400 hover:text-blue-300 transition-colors"
                        data-oid="xk84ip."
